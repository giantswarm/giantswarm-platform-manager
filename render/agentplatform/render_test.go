...
// listed by the Component; a hand-kept portal with the chat, whose fragment
// carries the block and no list; a portal without the chat, whose fragment
// carries none of it and no Secret; and both providers among the chats.
