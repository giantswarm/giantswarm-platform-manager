...
func TestPlan(t *testing.T) {
	r := tools.CapabilityResult{
		...
		Installations: []plan.Installation{{
			...
			Includes:         []plan.Include{{Repository: acmeMCs, Path: "management-clusters/rowan/extras/kustomization.yaml", Resource: "./agent-platform/"}},
	...
	contains(t, out, "enable_capability dry run: agent-platform on hub hazel, as someone", "Order: rowan",
		...
		"Includes: giantswarm/acme-management-clusters:management-clusters/rowan/extras/kustomization.yaml ./agent-platform/",
